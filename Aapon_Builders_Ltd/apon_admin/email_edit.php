<?php $conn = new mysqli("localhost", "root", "", "apon_builders_ltd") or die(mysqli_error($conn)); ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="#" class="nav-link active">
                            ...
                            <p>Email & Number<i class="fas fa-angle-left right"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="email_number.php" class="nav-link">
                               ...
                               <div class="card card-primary">
                                   ...
                                   $number = "";
                                    if (isset($_GET['submit'])){
                                        ...
                                        $sql = $conn->query("UPDATE email_number WHERE id= 1 ");
                                   ...
                                   ?>
                                <!-- form start -->
                                   <form  action="email_number.php" method="post">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="number" class="form-control"  placeholder="Number" value="<?php echo $number; ?>">
                                                </div>
                                            </div>
